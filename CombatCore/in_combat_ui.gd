...
func _update_labels(enemy: Enemy, player: Player, enemy_max_hull_hp, enemy_cur_hull_hp, player_max_hull_hp, player_cur_hull_hp, player_crew_max, player_crew_cur) -> void:
	enemy_label.text = "%s\nHull HP: %s/%s\nCrew: %s/%s\nSpecial Crew: %s/%s" % [enemy.enemy_data.enemy_name, enemy_cur_hull_hp, enemy_max_hull_hp, enemy.ship_holder.cur_crew_members, enemy.ship_holder.ship_type.crew_member_max, enemy.ship_holder.cur_special_crew_members, enemy.ship_holder.ship_type.special_crew_member_max]
	player_label.text = "Player Ship\nHull HP: %s/%s\nCrew: %s/%s\nSpecial Crew: %s/%s" % [player_cur_hull_hp, player_max_hull_hp, player_crew_cur, player_crew_max, player.ship_holder.cur_special_crew_members, player.ship_holder.ship_type.special_crew_member_max]
